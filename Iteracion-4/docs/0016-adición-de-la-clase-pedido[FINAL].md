...
* Permite crear almacenar las referencias a los objetos en varios lugares (por ejemplo: Listado de pedidos de la aplicación e historial de pedidos del cliente).
